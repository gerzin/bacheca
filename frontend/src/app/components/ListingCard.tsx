            ...
            <div className="mt-3 flex items-center justify-between gap-2 border-t border-zinc-100 pt-3 dark:border-zinc-800">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <a
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-violet-500 text-white shadow-sm transition-all hover:scale-105 hover:bg-violet-600 hover:shadow-md"
                        title="Chiama"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <svg
